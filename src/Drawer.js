...
function ResponsiveDrawer(props) {
    ...
    return (
        ...
        <CssBaseline />
        <AppBar position="fixed" className={classes.appBar} style={{'backgroundColor': '#2f53ff'}}>
            <Button variant="contained" style={{'marginLeft':'90%', 'backgroundColor': '#0009b8', 'color': 'white'}}
                onClick={() => getLang()}>
                {lang}
            </Button>
            <Toolbar>
