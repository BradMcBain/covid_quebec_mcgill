    ...
    if (this.props.lang === 'en') {
      drawer = (
        <div>
          ...
          />
          <Divider />
          <List className={classes.first}>MONTREAL</List>
          <List>
            {[
              'Map',
              'Cases per day',
          ...
          <Divider />
          <Divider />
          <List className={classes.first}>PROVINCE</List>
          <List>
            {[
              'Map',
              'Cases per day',
      ...
      drawer = (
        <div>
          ...
          />
          <Divider />
          <List className={classes.first}>MONTRÉAL</List>
          <List>
            {[
              'Carte',
              'Cas par jour',
