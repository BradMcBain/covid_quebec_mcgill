        ...
        if (this.props.lang === "en") {
            ...
            'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '90%', 'marginBottom':'18%'}}/>
                     ...
                     <Divider />
                         ...
                         <List>
                             {['Map', 'Cases per day', 'Cases per type', 'Age distribution', 'Tests', 'Quebec vs. the world', 'Rate of change', 'Days to double'].map((text, index) => (
            ...
            'display': 'block', 'marginLeft': 'auto', 'marginRight': 'auto', 'width': '90%', 'marginBottom':'18%'}}/>
                     ...
                     <Divider />
                        <List className = {classes.first} >
                         ...
                         <List>
                             {['Carte', 'Cas par jour', 'Cas par type', 'Répartition par âge', 'Tests', 'Québec vs. monde', 'Taux de variation', 'Jours pour doubler'].map((text, index) => (
                             <ListItem button key={text} onClick={() => this.jumpTo(index + 5)}>
                                 <ListItemText primary={text} classes={{primary: classes.li}}/>
                             </ListItem>
                             ))}
