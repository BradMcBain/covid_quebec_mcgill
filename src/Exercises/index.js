      ...
      <React.Fragment>
        <Grid item xs = {12} container spacing = {0} direction = "column" alignItems = "center" justify = "center">
             <Paper style = {styles.Paper} elevation = {5}>
                ...
                <font style = {styles.description}> The exhibit shows the number of cases in each Integrated University Health and Social Services Center (CIUSS).
    ...
    return (
      <React.Fragment>
        <Grid item xs = {12} container spacing = {0} direction = "column" alignItems = "center" justify = "center">
             <Paper style = {styles.Paper} elevation = {5}>
                 <h1 style = {styles.h2}> Cases by CIUSSS </h1>
                <font style = {styles.description}> This graph depicts the trend in the daily number of confirmed cases by Integrated University Health and Social Services Center (CIUSSS). <br> </br> <br> </br> The second exhibit shows the number of cases in each Integrated University Health and Social Services Center (CIUSS).
    ...
    return (
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">             <Paper style={styles.Paper} elevation={5}>
              ...
              <font style={styles.description}>
              This exhibit shows the number of trips planned in the citymapper mobile app, compared to a typical period of use (i.e. 4 weeks between January 6 and February 2, 2020). The citymapper mobility index is used for public transport users, as well as for walking, cycling, micro-mobility and taxis. The index does not consider driving in private vehicles.
              </font>
            </Paper>
        </Grid>
        <Grid item xs = {12}>
    ...
    return (
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">             <Paper style={styles.Paper} elevation={5}>
              <h1 style = {styles.h2}> Cases by age group </h1>
              <font style = {styles.description}>
              This pie chart illustrates the distribution of confirmed cases by age group. </font>
            </Paper>
        </Grid>
        <Grid item xs = {12}>
    ...
    return (
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">             <Paper style={styles.Paper} elevation={5}>
              <h1 style = {styles.h2}> Cases per day - Montreal </h1>
              <font style = {styles.description}>
              This stacked bar graph illustrates the number of new daily cases in each borough of Montreal. To select a particular district, you can click on the graph. <br> </br> <br> </br>
              </font>
              </Paper>
        </Grid>
        <Grid item xs = {12}>
      ...
      <React.Fragment>
        ...
        <Paper style = {styles.Paper} elevation = {5}>
             <h1 style = {styles.h2}> Test rate </h1>
              <font style = {styles.description}>
              This graph illustrates the daily number of positive tests (confirmed cases), negative tests and tests under investigation. The tests under investigation will eventually become positive or negative. </font>
            </Paper>
        </Grid>
        <Grid item xs = {12}>
             <Paper style = {styles.Paper} elevation = {5}>
    ...
    <React.Fragment>
        ...
        <Paper style={styles.Paper} elevation={5}>
           <h1 style={styles.h2}>Number of deaths: Quebec vs. The world</h1>
              <font style = {styles.description}>
              Left Table: This shows the trajectory in the number of cases in Quebec, relative to other countries. In the x-axis, we plot the number of days since the total number of deaths, in each region, reached five. In the y-axis, we plot the total number of deaths. The straight gray lines show trajectories for a doubling time of 2 days, 3 days, 5 days and 10 days. If a country's line on the chart is higher than those lines, then its number of deaths is doubling faster than that.
              <br> </br>
              <br> </br>
      ...
      <React.Fragment>
        ...
        <Paper style={styles.Paper} elevation={5}>
             <h1 style={styles.h2}>Québec vs. Monde</h1>
              ...
              <br></br>
              <br></br>
              Right Table: This scatter plot illustrates how Quebec compares to the rest of Canada (and other countries), in terms of screening rate and number of cases. On the ordinate axis (y), we test the rate (number of tests per 100,000 inhabitants). On the x-axis, we plot the number of cases.
              <br> </br> <br> </br> Ideally, we want the regions to perform very well in terms of test rate, while having a low number of cases. In other words, in an ideal scenario, the regions should be in the upper left region of the graph. You can click on the map to choose a specific region.
             </font>
            </Paper>
        </Grid>
        <Grid item xs = {12}>
      ...
      <React.Fragment>
        ...
        <Paper style = {styles.Paper} elevation = {5}>
             <h1 style = {styles.h2}> Test rate: Quebec vs. World </h1>
              <font style = {styles.description}>
              This scatter plot illustrates how Quebec compares to the rest of Canada (and other countries), in terms of screening rate and number of cases. On the ordinate axis (y), we test the rate (number of tests per 100,000 inhabitants). On the x-axis, we plot the number of cases.
              <br> </br> <br> </br> Ideally, we want the regions to perform very well in terms of test rate, while having a low number of cases. In other words, in an ideal scenario, the regions should be in the upper left region of the graph. You can click on the map to choose a specific region. </font>
            </Paper>
        </Grid>
        <Grid item xs = {12}>
             <Paper style = {styles.Paper} elevation = {5}>
