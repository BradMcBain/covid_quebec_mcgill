...
const styles = {
        ...
        h3:{ color:"#334B63", display:"block", textAlign:"center", fontFamily: "avenir" },
        source: { display:"inline", textAlign: "left", color: "#334B63", marginLeft: 12, marginBottom:100, fontFamily:"avenir" },
        frags: {
        }
}
    ...
    return (
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">             <Paper style={styles.Paper} elevation={5}>
              ...
              <font size="4" color="#334B63" margin-bottom="100" face="avenir">
      ...
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">
             <Paper style={styles.Paper} elevation={5}>
                ...
                <font size="4" color="#334B63" margin-bottom="100" face="avenir">The exhibit shows the number of cases in each Integrated University Health and Social Services Centre (CIUSS).
    ...
    return (
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">
             <Paper style={styles.Paper} elevation={5}>
                 <h1 style={styles.h3}>Cases by CIUSSS</h1>
                <font size="4" color="#334B63" margin-bottom="100" face="avenir">This graph depicts the trend in the daily number of confirmed cases by Integrated University Health and Social Services Centre (CIUSSS).  <br></br><br></br>The second exhibit shows the number of cases in each Integrated University Health and Social Services Centre (CIUSS).
      ...
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">
             <Paper style={styles.Paper} elevation={5}>
                ...
                <font size="4" color="#334B63" margin-bottom="100" face="avenir">This pie chart shows the distribution of confirmed cases by age group.
      ...
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">
             <Paper style={styles.Paper} elevation={5}>
                ...
                <font size="4" color="#334B63" margin-bottom="100" textAlign="center" face="avenir">
      ...
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">
             <Paper style={styles.Paper} elevation={5}>
                ...
                <font size="4" color="#334B63" margin-bottom="100" face="avenir">This map shows the number of confirmed cases in each montreal borough. You can click on the map to see the exact number of cases in each neighbourhood.
                </font>
            </Paper>
        </Grid>
        <Grid item xs={12}>
    ...
    return (
      <React.Fragment>
        <Grid item xs={12} container spacing={0} direction="column" alignItems="center" justify="center">             <Paper style={styles.Paper} elevation={5}>
              ...
              <font size="4" color="#334B63" margin-bottom="100" face="avenir">Cette carte montre le nombre de cas confirmés dans chacun des arrondissements de Montréal. Vous pouvez cliquer sur la carte pour voir le nombre exact de cas dans chaque quartier.
              </font>
            </Paper>
        </Grid>
        <Grid item xs={12}>
